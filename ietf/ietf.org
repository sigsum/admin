...
* perpass
* abfab
[[file:/u/ietf/internet-drafts/draft-ietf-abfab-arch-10.txt]]
[[file:/u/ietf/internet-drafts/draft-ietf-abfab-aaa-saml-08.txt]]
[[file:/u/ietf/internet-drafts/draft-ietf-abfab-gss-eap-09.txt]] now RFC 7055
[[file:/u/ietf/internet-drafts/draft-ietf-abfab-eapapplicability-06.txt]] now RFC 7057
[[file:/u/ietf/internet-drafts/draft-ietf-abfab-usecases-05.txt]]
...
[[file:/u/ietf/in-notes/rfc3748.txt]] EAP
[[file:/u/ietf/in-notes/rfc7055.txt]] a GSS-API mech for EAP
[[file:/u/ietf/in-notes/rfc7057.txt]] EAP for ABFAB
[[file:/u/ietf/in-notes/rfc7029.txt]] EAP mutual cryptographic binding using EMSK
[[file:/u/ietf/in-notes/rfc6677.txt]] channel binding for EAP methods
[[file:/u/ietf/internet-drafts/draft-ietf-emu-eap-tunnel-method-10.txt]] TEAP
[[file:/u/ietf/in-notes/rfc5056.txt]] (GSS-API) channel binding
[[file:/u/ietf/in-notes/rfc3579.txt]] EAP over RADIUS

[[file:/u/ietf/in-notes/rfc4462.txt]] GSS-API authn & kex for SSH
[[file:/u/ietf/in-notes/rfc4253.txt]] SSH transport, incl. DH kex

[[file:/u/ietf/in-notes/rfc6678.txt]] tunnel-based EAP methods, requirements
...
- MSK (EAP)
One MSK (Master Session Key) and one EMSK (Extended MSK) for each
[ABFAB? EAP?] session which is shared by the Client, the RP and the
IdP. [Transported all over the place, esp. AAA without end-to-end
confidentiality or integrity]

- CRK (GSS?)
Context Root Key, derived from the GMSK (GSS-API MSK).

- GMSK (GSS)
Derived from the MSK using the encryption type of the mechanism in use.
...
- [[file:/u/ietf/internet-drafts/draft-ietf-abfab-arch-10.txt::4.2.%20Privacy%20Aspects%20of%20ABFAB%20Communication%20Flows][file:/u/ietf/internet-drafts/draft-ietf-abfab-arch-10.txt::4.2. Privacy Aspects of ABFAB Communication Flows]]
...
- [[file:/u/ietf/in-notes/rfc7057.txt::4.%20Security%20Considerations][file:/u/ietf/in-notes/rfc7057.txt::4. Security Considerations]]
...
*** Abstract
This [doc] describes how EAP-GSS provides forward secrecy by
encrypting each session in an ephemeral key [DH:ed] and shared by the
initiator (EAP peer) and acceptor (EAP authenticator).

[To stop someone with access to traffic going between an ABFAB user and
her Identity Provider, possibly by being on the path (like all the
entitites in the AAA fabric are), from getting access to key material
[and more],]
...
Q: _remove_ any other crypto now that we have this?
Q: authenticate too? where and how?

7055 states:
- initial (vendor, name req+resp)
- authenticate (eap req+resp)
- extensions (flags, gss channel binding, MIC)


Q: 7055 "context establishment" and this, how do they relate?

Q: they run from GSS initiator to acceptor though, so how do we set up
keys with the EAP server? pass-through?

Q: will this mess up the [[file:/u/ietf/in-notes/rfc7055.txt::4.%20Selection%20of%20EAP%20Method][selection of EAP method]]?

*** Introduction / background / ABFAB architecture
[use (parts of) [[*introduction][introduction]]]

*** Problem Statement / The threat(s)

*** The solution

*** The costs
- This will cost FIXME extra roundtrips.
- New GSS mech? How to pick the right one?

* EAP
- [[file:/u/ietf/in-notes/rfc3748.txt][rfc3748]] EAP
- [[file:/u/ietf/in-notes/rfc5247.txt][rfc5247]] EAP key management
...
- EMSK?
* GSS-API and SASL
- [[file:/u/ietf/in-notes/rfc2743.txt][rfc2743]] GSS-API version 2
- [[file:/u/ietf/in-notes/rfc4422.txt][rfc4422]] SASL
- [[file:/u/ietf/in-notes/rfc5056.txt][rfc5056]] (GSS-API) channel binding
- [[file:/u/ietf/in-notes/rfc5247.txt::Extensible%20Authentication%20Protocol%20(EAP)%20Key%20Management%20Framework][rfc5247]] EAP key management
- [[file:/u/ietf/in-notes/rfc5801.txt][rfc5801]] GSS-API and SASL: GS2
