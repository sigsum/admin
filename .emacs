...
(custom-set-variables
 ...
 '(gnus-agent-plugged-hook '(gnus-group-send-queue))
 ...
 '(jabber-activity-banned '("twitter"))
 ...
 '(jabber-info-message-alist '((browse . "Browse request completed")))
 '(jabber-invalid-certificate-servers '("nordu.net"))
...
")
 ...
 '(message-hidden-headers '("^Gcc:\\|^Xref:\\|^X-Draft-From:\\|^References:"))
 ...
 '(mm-discouraged-alternatives '("text/html" "text/richtext" "multipart/related"))
 ...
 '(mml-secure-openpgp-signers '("0x1E8BF34923291265"))
 ...
 '(nnmail-extra-headers '(Keywords To Newsgroups Cc))
 ...
 '(w3m-file-coding-system 'w3m-iso-latin-1)
 '(w3m-file-name-coding-system 'w3m-iso-latin-1)
