...
* May 2023
Vacation: 2-5, 8-9 -- 6 days (5 glasklar)
...
*** TODO [0/5]
- [ ] stprov: built kernel, in container
  podman run can apt install but podman build can not?
- [ ] make sure we have access to OOB for stime
- [-] keykeeper [2/3]
  ...
  - [ ] built sthsm provisioning program and included it in stage4
