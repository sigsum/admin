...
* May 2023
Vacation: 2-5, 8-9 -- 6 days (5 of which are Glasklar days)
 Extra Glasklar on Fri 2023-05-12, so -1 Glasklar vacation days (4).
 Extra Glasklar on Fri 2023-05-19, so -1 Glasklar vacation days (3).
 Extra Glasklar on Fri 2023-05-26, so -1 Glasklar vacation days (2).
...
- old credentials, how to go forward?
  ...
  - need ssh key for
    - ~/p/tor/maatuska/maatuska-update-conf.sh 
...
git config user.email linus@glasklarteknik.se
